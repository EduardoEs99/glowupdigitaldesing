      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {SERVICES.map((service) => (
            <div 
              key={service.id}
              className="group p-6 md:p-8 rounded-2xl glass-panel bg-surface/40 hover:bg-white/5 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(139,92,246,0.15)] border-white/5 hover:border-white/20"
            >
